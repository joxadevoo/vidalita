...
CREATE TABLE beauty_health_info (
  id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
-- Indexlar
CREATE INDEX idx_members_qrcodeid ON members(qrcodeid);
CREATE INDEX idx_members_fullname ON members(fullname);
CREATE INDEX idx_members_phone ON members(phone);
CREATE INDEX idx_members_gymactive ON members(gymactive);
CREATE INDEX idx_members_lastupdated ON members(lastupdated);
CREATE INDEX idx_checkins_memberid ON checkins(memberid);
CREATE INDEX idx_checkins_date ON checkins(date);
CREATE INDEX idx_beauty_services_memberid ON beauty_services(memberid);
CREATE INDEX idx_beauty_services_date ON beauty_services(servicedate);
CREATE INDEX idx_gym_payments_memberid ON gym_payments(memberid);
CREATE INDEX idx_gym_payments_date ON gym_payments(paymentdate);
CREATE INDEX idx_gym_memberships_memberid ON gym_memberships(memberid);
CREATE INDEX idx_gym_memberships_active_date ON gym_memberships(active, enddate);
